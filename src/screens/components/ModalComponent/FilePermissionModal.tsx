  ...
  return (
    <View style={styles.modal}>
      ...
      <Text
        ...
        {'To use this feature, you need to allow'}
      </Text>
      <Text
        style={{
          fontFamily: 'MerriweatherSans-Bold',
...
const FilePermissionModal = (): JSX.Element | null => {
  const { isOpen, closeModal } = useModalManager('FilePermissionModal');
  const visible = isOpen('FilePermissionModal');

  const onClose = (): void => {
    closeModal('FilePermissionModal');
  };
